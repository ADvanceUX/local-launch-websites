...
const projects = [
  ...
  { name: "Hospitality Website Sample", brand: "The Local Table", type: "For hospitality businesses", headline: "A warm welcome before they walk in.", subhead: "Simple, polished websites for cafes, restaurants and local food businesses.", services: ["Menus", "Opening hours", "Booking enquiries"], blurb: "A clean, welcoming website for cafes, restaurants or local food businesses, with menus, opening hours and a clear way for customers to book or enquire.", pos: "50% 100%" },
